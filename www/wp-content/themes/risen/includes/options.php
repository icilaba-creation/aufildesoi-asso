...
if ( ! function_exists( 'optionsframework_options' ) ) {
	...
	function optionsframework_options() {
		...
		$options[] = array(
			...
			$options[] = array(
				"name" 	=> __( 'Search Page Title', 'risen' ),
				"desc" 	=> __( 'This is the title format that blog search pages use. The [keyword] shortcode is automatically replaced.', 'risen' ),
				"id" 	=> "blog_speaker_title",
				"std" 	=> risen_option_default( 'blog_search_title' ),
				"type" 	=> "text"
			);
...
TEXT;
		...
		$defaults['blog_search_title']					= "Search results for '[keyword]'";	
